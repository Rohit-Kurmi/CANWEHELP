<%@ Page Title="" Language="C#" MasterPageFile="~/page/masterpage.Master" AutoEventWireup="true" CodeBehind="patientregistration.aspx.cs" Inherits="Library_mng.patientregistration" %>
            ...
            <form id="registrationpage" runat="server">
                ...
                <div class="row d-md-flex " >
                    ...
                    <div class="col-md-3 pb-4 py-4  border border-muted">
                        <div class="form-group">
                            <asp:Button ID="btnreset" runat="server" Text="Reset" class="form-control submit bg-warning text-white px-3 px-4" />
