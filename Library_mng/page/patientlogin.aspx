                        ...
                        <div class="row  mt-4">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <asp:Label ID="plabel1" runat="server" Text=""><b>Patient Login Id</b><span class="text-danger">*</span></asp:Label>
                                </div>
                            </div>
                        </div>
                        <div class="row  mt-2">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <asp:TextBox ID="loginid" placeholder="Patient Login Id" runat="server" CssClass="form-control" onblur="return ValidateUid();"></asp:TextBox>
                                </div>
                            </div>
                        </div>
